...
```{r echo=TRUE}
for (psuedocount_iteration in c(1, 1*10^-1, 1*10^-2, 1*10^-3, 1*10^-4, 1*10^-5, 1*10^-6, 1*10^-7, 1*10^-8, 1*10^-9)) {
  hgd()
  hgd_view()
  #dev.off()
  print(psuedocount_iteration)
  
  feature_table_CLR_standardized_merged_conditions = select(feature_table_TIC_normalization_merged_conditions, -Conditions) %>% decostand(method = "clr", pseudocount = psuedocount_iteration)
  ...
  boxplot_raw_3153 = ggplot(feature_table_merged_conditions, aes(x = Conditions, y = log(feature_table_merged_conditions$`X3153` + 1), fill = Conditions)) +
    ggtitle("Estrone (raw data, log transformed)") +
  ...
  #print(plot_grid(boxplot_raw_3153, boxplot_TIC_normalization_3153, boxplot_CLR_standardization_3153))
  #dev.new()
  plot_grid(boxplot_raw_3153, boxplot_TIC_normalization_3153, boxplot_CLR_standardization_3153)
  #dev.off()
  #print(grid_plot)
}
#dev.off()
...
```{r}
feature_table_CLR_standardized_merged_conditions = select(feature_table_TIC_normalization_merged_conditions, -Conditions) %>% decostand(method = "clr", pseudocount = 0.000000000001)
feature_table_CLR_standardized_merged_conditions
...
```{r}
feature_table_RCLR_standardized_merged_conditions = select(feature_table_TIC_normalization_merged_conditions, -Conditions) %>% decostand(method = "rclr")
...
### kNN Imputation (VIM)
```{r}
KNN_input_feature_table_merged_conditions = feature_table_TIC_normalization_merged_conditions
...
```{r}
#Copy full data set for RF imputation
random_forests_imputation_merged_conditions = feature_table_TIC_normalization_merged_conditions
...
random_forests_imputation_CLR_standardization_merged_conditions$Conditions = factor(random_forests_imputation_CLR_standardization_merged_conditions$Conditions, levels = c("Allmix_BK_10pM", "Allmix_BK_100pM", "Allmix_BK_1nM", "Allmix_BK_10nM", "Allmix_BK_100nM", "Allmix_BK_1uM", "Allmix_BK_10uM")) #Convert "Conditions" variable to a factor, specifying the correct levels (order) of concentrations for all subsequent plotting
random_forests_imputation_CLR_standardization_merged_conditions
```
...
# 
# #, main = "Raw Data PCA"
# PCA_plot_raw = autoplot(PCA_results_raw, data = feature_table_merged_conditions, colour = "Conditions", frame = TRUE, frame.type = 'norm') +
#   theme_bw() +
#   #stat_ellipse() +
...
PCA_plot_raw = ggplot(pca_data, aes(x = PC1, y = PC2, color = Concentration, fill = Concentration)) +
  ...
  stat_ellipse(level = 0.95)  + # 95% confidence interval ellipse
...
# Create a data frame with PCA results and species information
pca_data <- data.frame(
  PC1 = pca_result$x[, 1] * -1, #Requested by Dr. Knight
  PC2 = pca_result$x[, 2],
  Concentration = feature_table_merged_conditions$Conditions
)
pca_data$Concentration <- as.character(pca_data$Concentration)
...
#### TIC
```{r}
boxplot_TIC_normalization_3153 = ggplot(feature_table_TIC_normalization_merged_conditions, aes(x = Conditions, y = log(feature_table_TIC_normalization_merged_conditions$`X3153` + 1e-12), fill = Conditions)) +
...
#0.000000000001
boxplot_TIC_normalization_3153
#ggsave("3151_ps_1.png", boxplot_TIC_normalization_3153, dpi = 1000, width = 8, height = 4.5, units = "in")
```

#### CLR
```{r}
boxplot_CLR_standardization_3153 = ggplot(feature_table_CLR_standardized_merged_conditions, aes(x = Conditions, y = feature_table_CLR_standardized_merged_conditions$`X3153`, fill = Conditions)) +
  ggtitle("Estrone (TIC-CLR transformed data)") +
  geom_boxplot(show.legend = FALSE) +
  geom_point(show.legend = FALSE) +
  theme_bw() +
  theme(plot.title = element_text(hjust = 0.5, face = "bold")) +
...
boxplot_RCLR_standardization_min_imputation_3153 = ggplot(feature_table_RCLR_standardization_min_value_imputation_merged_conditions, aes(x = Conditions, y = feature_table_RCLR_standardization_min_value_imputation_merged_conditions$`X3153`, fill = Conditions)) +
  ggtitle("Estrone (TIC-RCLR transformation, min imputation)") +
  geom_boxplot(show.legend = FALSE) +
  geom_point(show.legend = FALSE) +
  theme_bw() +
  theme(plot.title = element_text(hjust = 0.5, face = "bold")) +
...
boxplot_RCLR_standardization_KNN_imputation_3153 = ggplot(feature_table_RCLR_standardization_KNN_imputation_merged_conditions, aes(x = Conditions, y = feature_table_RCLR_standardization_KNN_imputation_merged_conditions$`X3153`, fill = Conditions)) +
  ggtitle("Estrone (TIC-RCLR transformation, kNN imputation)") +
  geom_boxplot(show.legend = FALSE) +
  geom_point(show.legend = FALSE) +
  theme_bw() +
  theme(plot.title = element_text(hjust = 0.5, face = "bold")) +
...
boxplot_RCLR_standardization_random_forests_imputation_3153 = ggplot(feature_table_RCLR_standardization_random_forests_imputation_merged_conditions, aes(x = Conditions, y = feature_table_RCLR_standardization_random_forests_imputation_merged_conditions$`X3153`, fill = Conditions)) +
  ggtitle("Estrone (TIC-RCLR transformation, R.F. imputation)") +
  geom_boxplot(show.legend = FALSE) +
  geom_point(show.legend = FALSE) +
  theme_bw() +
  theme(plot.title = element_text(hjust = 0.5, face = "bold")) +
...
boxplot_CLR_standardization_1030 = ggplot(feature_table_CLR_standardized_merged_conditions, aes(x = Conditions, y = feature_table_CLR_standardized_merged_conditions$`X1030`, fill = Conditions)) +
  ggtitle("Aspartame (TIC-CLR transformed data)") +
  geom_boxplot(show.legend = FALSE) +
  geom_point(show.legend = FALSE) +
  theme_bw() +
  theme(plot.title = element_text(hjust = 0.5, face = "bold")) +
...
boxplot_RCLR_standardization_min_imputation_1030 = ggplot(feature_table_RCLR_standardization_min_value_imputation_merged_conditions, aes(x = Conditions, y = feature_table_RCLR_standardization_min_value_imputation_merged_conditions$`X1030`, fill = Conditions)) +
  ggtitle("Aspartame (TIC-RCLR transformation, min imputation)") +
  geom_boxplot(show.legend = FALSE) +
  geom_point(show.legend = FALSE) +
  theme_bw() +
  theme(plot.title = element_text(hjust = 0.5, face = "bold")) +
...
boxplot_RCLR_standardization_KNN_imputation_1030 = ggplot(feature_table_RCLR_standardization_KNN_imputation_merged_conditions, aes(x = Conditions, y = feature_table_RCLR_standardization_KNN_imputation_merged_conditions$`X1030`, fill = Conditions)) +
  ggtitle("Aspartame (TIC-RCLR transformation, kNN imputation)") +
  geom_boxplot(show.legend = FALSE) +
  geom_point(show.legend = FALSE) +
  theme_bw() +
  theme(plot.title = element_text(hjust = 0.5, face = "bold")) +
...
boxplot_RCLR_standardization_random_forests_imputation_1030 = ggplot(feature_table_RCLR_standardization_random_forests_imputation_merged_conditions, aes(x = Conditions, y = feature_table_RCLR_standardization_random_forests_imputation_merged_conditions$`X1030`, fill = Conditions)) +
  ggtitle("Aspartame (TIC-RCLR transformation, R.F. imputation)") +
  geom_boxplot(show.legend = FALSE) +
  geom_point(show.legend = FALSE) +
  theme_bw() +
  theme(plot.title = element_text(hjust = 0.5, face = "bold")) +
...
ggsave("1030_grid_boxplots.svg", grid_boxplots_3153, width = 16, height = 9, units = "in", dpi = 1000)
```
...
formula_string <- paste0("y = ", round(intercept, 2), " + ", round(slope, 2), " * ln(x)")
formula_string
...
log_imp_point_1872 = ggplot(data_frame, aes(x = Concentrations, y = data_frame[, 2], colour = Concentrations)) +
  ggtitle("C17 Sphingosine logarithmic regression (TIC-RCLR transformation)") +
...
data_frame
data_frame$Concentrations = factor(data_frame$Concentrations, levels = c("Allmix_BK_10pM", "Allmix_BK_100pM", "Allmix_BK_1nM", "Allmix_BK_10nM", "Allmix_BK_100nM", "Allmix_BK_1uM", "Allmix_BK_10uM")) 

boxplot_RCLR_1872 = ggplot(data_frame, aes(x = Concentrations, y = X1872_i, fill = Concentrations)) +
  ggtitle("C17 Sphingosine (TIC-RCLR transformation)") +
  geom_boxplot(show.legend = FALSE) +
  geom_point(show.legend = FALSE) +
  theme_bw() +
  theme(plot.title = element_text(hjust = 0.5, face = "bold")) +
...
log_imp_point = ggplot(data_frame2, aes(x = Concentrations, y = data_frame2[, 2], colour = Concentrations)) +
  ggtitle("Aspartame logarithmic regression imputation (TIC-RCLR transformation)") +
  geom_point(size=3, show.legend = FALSE) +
  geom_smooth(method = "lm", formula = y ~ log(x), se = FALSE, color = "black") +
  scale_colour_gradientn(colours = c("#F8766D", "#C49A00", "#53B400", "#00C094", "#00B6EB", "#A58AFF", "#FB61D7"),
                         values = rescale(c(1e-11, 1e-10, 1e-9, 1e-8, 1e-7, 1e-6, 1e-5))) +
...
log_reg_plots = add_sub(log_reg_plots, "Concentration")
ggsave("log_reg_plots.png", log_reg_plots, width = 16, height = 9, units = "in", dpi = 1000)
ggsave("log_reg_plots.svg", log_reg_plots, width = 16, height = 9, units = "in", dpi = 1000)
```
